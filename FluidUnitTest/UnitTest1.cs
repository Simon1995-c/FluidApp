...
namespace FluidUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestFærdigvarekontrol()
        {
            ...
            a.Post(new Færdigvarekontrol() { FK_Kolonne = 1, DåseNr = 1, Initialer = "Test", LågNr = 1, DatoMærkning = DateTime.Now, LågFarve = "Rød", RingFarve = "Grøn", Enheder = 1, Parametre = "Test", Multipack = 1, FolieNr = 1, KartonNr = 1, PalleNr = 1 });
            ...
            a.Put(lastItem.ProcessordreNr, new Færdigvarekontrol() { ProcessordreNr = lastItem.ProcessordreNr, FK_Kolonne = 1, DåseNr = 1, Initialer = "Opdateret", LågNr = 1, DatoMærkning = DateTime.Now, LågFarve = "Rød", RingFarve = "Grøn", Enheder = 1, Parametre = "Test", Multipack = 1, FolieNr = 1, KartonNr = 1, PalleNr = 1 });
        ...
        public void TestForside()
        {
            ...
            a.Post(new Forside() { FK_Kolonne = 1, FærdigvareNr = 1, FærdigvareNavn = "test", ProcessordreNr = 1, Produktionsinitialer = "Test", Dato = DateTime.Now });
            ...
            a.Put(lastItem.ID, new Forside() { ID = lastItem.ID, FK_Kolonne = 1, FærdigvareNr = 1, FærdigvareNavn = "Opdateret", ProcessordreNr = 1, Produktionsinitialer = "Test", Dato = DateTime.Now });
        ...
        public void TestKontrolRegistering()
        {
            ...
            a.Post(new Kontrolregistrering() { FK_Kolonne = 1, Klokkeslæt = DateTime.Now, Holdbarhedsdato = DateTime.Now, Produktionsdato = DateTime.Now, FærdigvareNr = 1, Kommentar = "Test", Spritkontrol = true, HætteNr = 1, EtiketNr = 1, Fustage = "Test", Signatur = "Test" });
            ...
            a.Put(lastItem.ID, new Kontrolregistrering() { ID = lastItem.ID, FK_Kolonne = 1, Klokkeslæt = DateTime.Now, Holdbarhedsdato = DateTime.Now, Produktionsdato = DateTime.Now, FærdigvareNr = 1, Kommentar = "Opdateret", Spritkontrol = true, HætteNr = 1, EtiketNr = 1, Fustage = "Test", Signatur = "Test" });
